...
-- Description: Create all base tables for authentication, daily logs, groups, and invitations
...
CREATE INDEX IF NOT EXISTS idx_daily_logs_checkbox_states ON daily_logs USING GIN (checkbox_states);
